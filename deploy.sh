...
docker-compose -f docker-compose.prod.yml build --build-arg REACT_APP_ALGOLIA_API_KEY=$REACT_APP_ALGOLIA_API_KEY --build-arg REACT_APP_ALGOLIA_APP_ID=$REACT_APP_ALGOLIA_APP_ID --build-arg REACT_APP_GOOGLE_CLIENT_ID=$REACT_APP_GOOGLE_CLIENT_ID --build-arg REACT_APP_GITHUB_CLIENT_ID=$REACT_APP_GITHUB_CLIENT_ID --build-arg REACT_APP_TINY_API_KEY=$REACT_APP_TINY_API_KEY
...
#sudo docker stop advicetracker-server
#sudo docker rm advicetracker-client
#sudo docker rm advicetracker-server
#sudo docker pull kthisisjosh/advicetracker:client
#sudo docker pull kthisisjosh/advicetracker:server
